...
public class SpringBootApplicationMockitoTest {
	...
	@Test
	 public void getEmployeeByIdTest()throws ResourceNotFoundException {
		...
		Optional<Employee> employee=Optional.of(new Employee("pollai","lakshmi","lakshmi@gmail.com"));
		when(employeeRepository.findById(5L)).thenReturn(employee).thenReturn(null);
		Employee emp=employeeService.getEmployeeById(5L);
		assertEquals("Lakshmi",emp.getFirstName());
		assertEquals("Pollai",emp.getLastName());
		assertEquals("lakshmi@gmail.com",emp.getEmailId());
		}
		
	@Test
	public void deleteEmployeeById() {
		Optional<Employee> employee=Optional.of(new Employee("pollai","lakshmi","laakshmi@gmail.com"));
	...
	public void deleteEmployeeByIdNotFound() {
		Employee employee=new Employee("pollai","Lakshmi","lakshmi@gmail.com");
		 employee.setId(1L);
	...
	public void updateEmployeeById() {
		Employee employee=new Employee("klk","kushi","kush@gmail.com");
		employee.setId(12L);	
