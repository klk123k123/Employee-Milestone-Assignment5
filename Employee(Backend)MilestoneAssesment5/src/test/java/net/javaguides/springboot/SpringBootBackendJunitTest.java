...
class SpringBootUnitTest
{
	    ...
	    public void updateEmployeeTest(){
	        ...
	        Assertions.assertThat(employeeUpdated.getEmailId()).isEqualTo("klk@gmail.com");
	    ...
	    public void deleteEmployeeTest(){
	        ...
	        Optional<Employee> optionalEmployee = employeeRepository.findByEmailId("kushi@gmail.com");
